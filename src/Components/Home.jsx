              ...
              <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                <div className="lg:py-24">
                  ...
                  <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                    ...
                    best nannies, and at your request, they are avail to your
                    home address as you as possible
                  </p>
                    ...
                    <form action="POST" className="sm:mx-auto lg:mx-0">
                      <div className="flex items-center m-0">
                        ...
                        <div className="sm:mt-0 sm:ml-3">
                          <Link to="/sign_up">
                            <button className="block w-full rounded-md bg-gradient-to-r from-teal-500 to-cyan-600 py-3 px-4 font-medium text-white shadow hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900">
                              Get Started
                            </button>
                          </Link>
                        </div>
                  ...
                  <div>
                    <Link to="/cards">
                      <button className="flex justify-center w-1/2 rounded-md bg-gradient-to-r from-teal-500 to-cyan-600 py-3 px-4 font-medium text-white shadow hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900 mt-12">
