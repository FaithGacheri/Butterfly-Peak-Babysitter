            ...
            <div className="text-white lg:flex flex-row pb-10">
              <div className="mt-0 pl-2 lg-flex lg:flex-col ">
                <img
                  ...
                  src="https://images.pexels.com/photos/4473602/pexels-photo-4473602.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                  alt="Caregiver"
                />
              </div>
              <div className=" lg:text-white sm:text-white ml-10 mt-10">
                <h2 className="lg:text-2xl">Naomi</h2>
                <h4>Location: Kiambu Road</h4>
              </div>
            </div>
          </div>
          ...
          <div className="text-gray-600 p-4">
            <div className="mb-20 w-3/4 ">
              ...
              <div className="p-4 border-b pb-10">
                <p>
                  Iam an honest new take on a classic. The tee uses super soft,
