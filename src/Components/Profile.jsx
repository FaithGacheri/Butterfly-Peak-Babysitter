          ...
          <div className="g1-card">
            ...
            <div className="g1-content">
              ...
              <p>
                ...
                debitis, ad ratione error at animi optio odio dolores dolor
                earum atque, facilis voluptatem quas eveniet maiores quaerat
          ...
          <div className="rightSide text-black">
            ...
            <div>
              <div>
                ...
                <div className="flex justify-between items-center mt-8 border-b">
                  <h3>Full name</h3>
                  <h3 className="mr-20">{user.caregiver.username}</h3>
                </div>
                <div className="flex justify-between items-center mt-8 border-b">
                  <h3>Email </h3>
                  <h3 className="mr-20">{user.caregiver.email}</h3>
                </div>
                <div className="flex justify-between items-center mt-8 border-b">
                  <h3>Phone Number </h3>
                  <h3 classname="mr-20">{user.caregiver.phonenumber}</h3>
                </div>
                <div className="flex justify-between items-center mt-8 border-b">
                  <h3>Address </h3>
                  <h3 className="mr-20">{user.caregiver.adress}</h3>
                </div>
              </div>
              <div className="flex justify-end">
                <button
